...
-- These two env variables are specific to Fedora.
-- AGS does not build properly so we need to set these variables by hand
hl.env("GI_TYPELIB_PATH", "/usr/local/lib64/girepository-1.0:/usr/local/lib/girepository-1.0")
hl.env("LD_LIBRARY_PATH", "/usr/local/lib64:/usr/local/lib")
